...
const menuItems = [
  ...
  {
    icon: Flower2,
    label: 'Produção de Mel',
  },
  {
    icon: Sprout,
    label: 'Produção de Chia',
  },
  {
    icon: PackageCheck,
    label: 'Barra Mel + Chia',
  },
  {
    icon: Boxes,
    ...
    <div className="space-y-6">
      ...
      <section>
        ...
        <p className="mt-2 text-gray-500">
          Acompanhe produção, estoque e pedidos da operação CAMC.
        </p>
      </section>
...
export default function App() {
  ...
  function renderPage() {
    ...
    switch (currentPage) {
      ...
      case 'Produção de Mel':
        return <ProducaoMel />;


      case 'Produção de Chia':
        return <ProducaoChia />;
  ...
  return (
    ...
    <div className="min-h-screen bg-amber-50/30 text-gray-800">
      ...
      <aside className="fixed inset-y-0 left-0 z-50 flex w-64 flex-col bg-amber-950 text-amber-50 shadow-xl">
